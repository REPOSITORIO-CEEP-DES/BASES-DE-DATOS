...
capture log close
log using "read_PC6.log", replace
use PC6.dta, clear
...
** nombres de variables así como las etiquetas
	...
	label variable  ptje_eqserce_cie6 "Puntaje estándar equiparado con SERCE Cie6"
	label variable  hab_eqserce_cie6 "Habilidad equiparada con SERCE Cie6"
	label variable nivel_cie6 "Nivel proyectando puntos de corte SERCE Ci6"
...
/** Para generar las bases de datos individuales y libro de codigos
	...
	save `id_int'_PC6.dta, replace
	}
	
*** Rename los archivos en la carpeta.

	shell rename 1_PC6.dta ARG_PM3.dta
	shell rename 2_PC6.dta BRA_PM3.dta
	shell rename 3_PC6.dta CHI_PM3.dta
	shell rename 4_PC6.dta COL_PM3.dta
