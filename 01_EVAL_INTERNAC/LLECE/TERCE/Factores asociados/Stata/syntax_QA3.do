...
cd "C:\Users\Adriana\Desktop\Bases_TERCE2015\UDP 15 de junio\Stata"
	...
	capture log close
	log using "read_QA3_TERCE.log", replace
	use QA3.dta
...
** Ordenar la base de datos
	...
	replace organa3=. if organa3==9
	replace asisdoa3=. if asisdoa3==9
